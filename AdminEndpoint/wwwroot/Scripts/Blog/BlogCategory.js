$(document).ready(function () {
    $("#dataTable").DataTable({
        ...
        columns: [
            ...
            { title: 'تعداد مقالات', data: 'posts', "width": "30px" },
            {
                title: 'ابزار',
                data: 'id',
                render: function (data) {
                    return `<div style="display:flex;">
                             <a href="/BlogCategory/Edit/${data}" title="ویرایش"  class="btn btn-info btn-icon"><i class="icofont icofont-info-square"></i></a>
