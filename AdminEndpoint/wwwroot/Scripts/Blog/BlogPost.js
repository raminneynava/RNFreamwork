...
$(document).ready(function () {
    $("#dataTable").DataTable({
        ...
        columns: [
            ...
            { title: 'دسته بندی', data: 'category', "width": "50px" },
            { title: 'وضعیت', data: 'status', "width": "30px" },
            { title: 'نویسنده', data: 'authorId', "width": "30px" },
            { title: 'تعداد نظرها', data: 'rate', "width": "30px" },
            { title: 'امتیاز', data: 'rate', "width": "30px" },
            {
                title: 'ابزار',
                data: 'id',
