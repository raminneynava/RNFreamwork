$(document).ready(function () {
    $("#dataTable").DataTable({
        ...
        ajax: {
            url: '/Discounts/GetList',
            dataSrc: '',
            type: "post"
        },
        columns: [
            { title: 'عنوان', data: 'title', "width": "50px" },
            { title: 'از تاریخ', data: 'startDate', "width": "30px" },
            { title: 'تا تاریخ', data: 'endDate', "width": "30px" },
            { title: 'نوغ تخفیف', data: 'discountType', "width": "30px" },
            {
                title: 'تنظیمات',
                data: 'id',
                render: function (data) {
                    return `<div style="display:flex;">
                             <a href="/Discounts/Edit/${data}" title="ویرایش"  class="btn btn-info btn-icon"><i class="icofont icofont-info-square"></i></a>
