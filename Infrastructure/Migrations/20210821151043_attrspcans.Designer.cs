...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20210821151043_attrspcans")]
    partial class attrspcans
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.Entities.Attribute.CategoryAttributeAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("CategoryAttributeSpeciId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CategoryAttributeSpeciId");

                    b.ToTable("CategoryAttributeAnswers");
                });

            modelBuilder.Entity("Infrastructure.Entities.Attribute.CategoryAttributeSpeci", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CategoryAttributeSpecis");
                });

            modelBuilder.Entity("Infrastructure.Entities.Attribute.SpecificationAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Infrastructure.Entities.Attribute.CategoryAttributeAnswer", b =>
                {
                    b.HasOne("Infrastructure.Entities.Attribute.CategoryAttributeSpeci", "CategoryAttributeSpeci")
                        .WithMany()
                        .HasForeignKey("CategoryAttributeSpeciId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("CategoryAttributeSpeci");
                });

            modelBuilder.Entity("Infrastructure.Entities.Attribute.CategoryAttributeSpeci", b =>
                {
                    b.HasOne("Infrastructure.Entities.Attribute.SpecificationAttribute", "Attributes")
                        .WithMany()
